            ...
            br1 = new BukkitRunnable() {
                public void run() {
                    for (int i = 0; i < gMap.getTeamCards().size(); i++) {
                        Location loc = new Location(gMap.getCurrentWorld(), ((TeamCard) gMap.getTeamCards().get(i)).getSpawn().getX(), ((TeamCard) gMap.getTeamCards().get(i)).getSpawn().getY(), ((TeamCard) gMap.getTeamCards().get(i)).getSpawn().getZ());
                        Location spawn;
                        do {
