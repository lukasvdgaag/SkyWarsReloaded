...
public class ArenaDamageListener implements org.bukkit.event.Listener
{
  ...
  @EventHandler
  public void satLoss(org.bukkit.event.entity.FoodLevelChangeEvent event)
  {
    if ((event.getEntity() instanceof Player)) {
      Player player = (Player)event.getEntity();
      GameMap gameMap = MatchManager.get().getPlayerMap(player);
  ...
  @EventHandler
  public void regen(org.bukkit.event.entity.EntityRegainHealthEvent event)
  {
    if (!(event.getEntity() instanceof Player)) {
      return;
    }
  ...
  @EventHandler
  public void bowEvent(org.bukkit.event.entity.EntityShootBowEvent event)
  {
    if (!(event.getEntity() instanceof Player)) {
      return;
    }
  ...
  @EventHandler
  public void arrowEvent(org.bukkit.event.entity.ProjectileHitEvent event)
  {
