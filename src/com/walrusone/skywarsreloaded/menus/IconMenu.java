...
public class IconMenu
{
  ...
  public void openInventory(Player player, int index) { player.openInventory((Inventory)invs.get(index)); }
  ...
  public static class OptionClickEvent { private Player player;
    private String name;
    private ClickType clickType;
    private ItemStack item;
    private int slot;
    
    OptionClickEvent(Player player, String name, ClickType clickType, ItemStack itemStack, int slot) { this.player = player;
      this.name = name;
