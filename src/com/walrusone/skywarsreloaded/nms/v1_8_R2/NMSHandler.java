...
public class NMSHandler implements com.walrusone.skywarsreloaded.api.NMS
{
  ...
  public void sendParticles(org.bukkit.World world, String type, float x, float y, float z, float offsetX, float offsetY, float offsetZ, float data, int amount) { net.minecraft.server.v1_8_R2.EnumParticle particle = net.minecraft.server.v1_8_R2.EnumParticle.valueOf(type);
