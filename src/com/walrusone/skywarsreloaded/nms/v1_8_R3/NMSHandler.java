...
public class NMSHandler implements com.walrusone.skywarsreloaded.api.NMS
{
  ...
  {
    ((org.bukkit.craftbukkit.v1_8_R3.CraftServer)org.bukkit.Bukkit.getServer()).getHandle().moveToWorld(((CraftPlayer)player).getHandle(), 0, false);
  }
  
  public void sendParticles(org.bukkit.World world, String type, float x, float y, float z, float offsetX, float offsetY, float offsetZ, float data, int amount) { net.minecraft.server.v1_8_R3.EnumParticle particle = net.minecraft.server.v1_8_R3.EnumParticle.valueOf(type);
    net.minecraft.server.v1_8_R3.PacketPlayOutWorldParticles particles = new net.minecraft.server.v1_8_R3.PacketPlayOutWorldParticles(particle, true, x, y, z, offsetX, offsetY, offsetZ, data, amount, new int[] { 1 });
  ...
  public String getItemName(org.bukkit.inventory.ItemStack item) {
    if (item != null) {
      return org.bukkit.craftbukkit.v1_8_R3.inventory.CraftItemStack.asNMSCopy(item).getName();
    }
    return "";
  }
  ...
  public void spawnDragon(org.bukkit.World world, Location loc)
  {
  ...
  public Entity spawnFallingBlock(Location loc, Material mat, boolean damage)
  {
    ...
    net.minecraft.server.v1_8_R3.EntityFallingBlock fb = ((CraftFallingSand)block).getHandle();
    fb.a(damage);
    return block;
  }
  ...
  {
    EntityCreature entity = (EntityCreature)((org.bukkit.craftbukkit.v1_8_R3.entity.CraftEntity)ent).getHandle();
  ...
  public void setGameRule(org.bukkit.World world, String rule, String bool)
  {
  ...
  public void setBlockWithColor(org.bukkit.World world, int x, int y, int z, Material mat, byte cByte)
  {
