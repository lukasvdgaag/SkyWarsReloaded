...
public class NMSHandler implements com.walrusone.skywarsreloaded.api.NMS
{
  ...
  {
    ((org.bukkit.craftbukkit.v1_11_R1.CraftServer)org.bukkit.Bukkit.getServer()).getHandle().moveToWorld(((CraftPlayer)player).getHandle(), 0, false);
  }
  ...
  public void sendParticles(World world, String type, float x, float y, float z, float offsetX, float offsetY, float offsetZ, float data, int amount) {
    net.minecraft.server.v1_11_R1.EnumParticle particle = net.minecraft.server.v1_11_R1.EnumParticle.valueOf(type);
    net.minecraft.server.v1_11_R1.PacketPlayOutWorldParticles particles = new net.minecraft.server.v1_11_R1.PacketPlayOutWorldParticles(particle, true, x, y, z, offsetX, offsetY, offsetZ, data, amount, new int[] { 1 });
  ...
  public String getItemName(org.bukkit.inventory.ItemStack item) {
    return org.bukkit.craftbukkit.v1_11_R1.inventory.CraftItemStack.asNMSCopy(item).getName();
  }
  ...
  public void updateSkull(Skull skull, java.util.UUID uuid)
  {
    ...
    skull.setOwningPlayer(org.bukkit.Bukkit.getOfflinePlayer(uuid));
  }
  ...
  public Entity spawnFallingBlock(Location loc, Material mat, boolean damage)
  {
    ...
    EntityFallingBlock fb = ((org.bukkit.craftbukkit.v1_11_R1.entity.CraftFallingBlock)block).getHandle();
    fb.a(damage);
    return block;
  }
  ...
  {
    EntityCreature entity = (EntityCreature)((org.bukkit.craftbukkit.v1_11_R1.entity.CraftEntity)ent).getHandle();
