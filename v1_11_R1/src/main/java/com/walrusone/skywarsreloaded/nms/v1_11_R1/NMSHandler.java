...
public class NMSHandler implements NMS {
    ...
    public SWRSign createSWRSign(String name, org.bukkit.Location location) {
        return new SWRSign11(name, location);
    }
    ...
    public void respawnPlayer(Player player) {
        ((org.bukkit.craftbukkit.v1_11_R1.CraftServer) Bukkit.getServer()).getHandle().moveToWorld(((CraftPlayer) player).getHandle(), 0, false);
    }
