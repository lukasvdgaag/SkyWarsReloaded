...
public class NMSHandler implements NMS {
    ...
    public SWRSign createSWRSign(String name, org.bukkit.Location location) {
        return new SWRSign91(name, location);
    }
    ...
    public void respawnPlayer(Player player) {
        ((org.bukkit.craftbukkit.v1_9_R1.CraftServer) Bukkit.getServer()).getHandle().moveToWorld(((CraftPlayer) player).getHandle(), 0, false);
    }
    ...
    public void sendParticles(World world, String type, float x, float y, float z, float offsetX, float offsetY, float offsetZ, float data, int amount) {
        net.minecraft.server.v1_9_R1.EnumParticle particle = net.minecraft.server.v1_9_R1.EnumParticle.valueOf(type);
        net.minecraft.server.v1_9_R1.PacketPlayOutWorldParticles particles = new net.minecraft.server.v1_9_R1.PacketPlayOutWorldParticles(particle, true, x, y, z, offsetX, offsetY, offsetZ, data, amount, new int[]{1});
    ...
    public void sendActionBar(Player p, String msg) {
        ...
        net.minecraft.server.v1_9_R1.PacketPlayOutChat bar = new net.minecraft.server.v1_9_R1.PacketPlayOutChat(icbc, (byte) 2);
        ((CraftPlayer) p).getHandle().playerConnection.sendPacket(bar);
    }

    public String getItemName(org.bukkit.inventory.ItemStack item) {
        return org.bukkit.craftbukkit.v1_9_R1.inventory.CraftItemStack.asNMSCopy(item).getName();
    }
    ...
    public void spawnDragon(World world, Location loc) {
        ...
        dragon.cT().a(net.minecraft.server.v1_9_R1.DragonControllerPhase.c);
    ...
    public Entity spawnFallingBlock(Location loc, Material mat, boolean damage) {
        ...
        net.minecraft.server.v1_9_R1.EntityFallingBlock fb = ((CraftFallingSand) block).getHandle();
        fb.a(damage);
        return block;
    }
