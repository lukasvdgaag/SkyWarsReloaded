...
//            world.setGameRuleValue("showDeathMessages", value);
//            //world.setGameRule(GameRule.SHOW_DEATH_MESSAGES, Boolean.valueOf(bool.toUpperCase()));
//        } else if (ruleName.equalsIgnoreCase("announceAdvancements")) {
//            world.setGameRuleValue("announceAdvancedments", value);
