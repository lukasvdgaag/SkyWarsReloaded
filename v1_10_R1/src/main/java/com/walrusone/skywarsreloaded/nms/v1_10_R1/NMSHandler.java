...
public class NMSHandler implements NMS {
    ...
    public SWRSign createSWRSign(String name, org.bukkit.Location location) {
        return new SWRSign10(name, location);
    }
    ...
    public void respawnPlayer(Player player) {
        ((org.bukkit.craftbukkit.v1_10_R1.CraftServer) Bukkit.getServer()).getHandle().moveToWorld(((CraftPlayer) player).getHandle(), 0, false);
    }
    ...
    public void sendParticles(World world, String type, float x, float y, float z, float offsetX, float offsetY, float offsetZ, float data, int amount) {
        net.minecraft.server.v1_10_R1.EnumParticle particle = net.minecraft.server.v1_10_R1.EnumParticle.valueOf(type);
        net.minecraft.server.v1_10_R1.PacketPlayOutWorldParticles particles = new net.minecraft.server.v1_10_R1.PacketPlayOutWorldParticles(particle, true, x, y, z, offsetX, offsetY, offsetZ, data, amount, new int[]{1});
    ...
    public String getItemName(org.bukkit.inventory.ItemStack item) {
        return org.bukkit.craftbukkit.v1_10_R1.inventory.CraftItemStack.asNMSCopy(item).getName();
    }
    ...
    public void spawnDragon(World world, Location loc) {
        ...
        dragon.getDragonControllerManager().setControllerPhase(net.minecraft.server.v1_10_R1.DragonControllerPhase.c);
    ...
    public Entity spawnFallingBlock(Location loc, Material mat, boolean damage) {
        ...
        net.minecraft.server.v1_10_R1.EntityFallingBlock fb = ((org.bukkit.craftbukkit.v1_10_R1.entity.CraftFallingSand) block).getHandle();
        fb.a(damage);
        return block;
    }
    ...
    public void setEntityTarget(Entity ent, Player player) {
        EntityCreature entity = (EntityCreature) ((org.bukkit.craftbukkit.v1_10_R1.entity.CraftEntity) ent).getHandle();
