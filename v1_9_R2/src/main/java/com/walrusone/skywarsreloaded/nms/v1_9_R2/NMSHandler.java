...
public class NMSHandler implements NMS {
    ...
    public SWRSign createSWRSign(String name, org.bukkit.Location location) {
        return new SWRSign92(name, location);
    }
    ...
    public void respawnPlayer(Player player) {
        ((org.bukkit.craftbukkit.v1_9_R2.CraftServer) Bukkit.getServer()).getHandle().moveToWorld(((CraftPlayer) player).getHandle(), 0, false);
    }
